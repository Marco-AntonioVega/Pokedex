...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    private enum Constants {
        ...
        static let favoriteNavigationControllerIdentifier = "FavoriteNavigationController"
        static let tabNavigationControllerIdentifier = "TabNavigationController"
    ...
    private func login() {
        ...
        self.window?.rootViewController = storyboard.instantiateViewController(withIdentifier: Constants.tabNavigationControllerIdentifier)
    }
